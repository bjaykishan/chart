...
{{/*
Common labels for master-key-regenerator pod
*/}}
{{- define "master-key-regenerator-pod.labels" -}}
helm.sh/chart: {{ include "ibm-pem-standard.chart" . }}
release: partnerEngagementStandard
{{ include "master-key-regenerator.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
{{/*
Common labels for network-policy
*/}}
...
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
app.kubernetes.io/name: {{ .Release.Name }}-network-policy
...
app.kubernetes.io/instance: {{ .Release.Name }}-pvc
{{- end }}
...
{{/*
Selector labels for master-key-regenerator pod
*/}}
{{- define "master-key-regenerator.selectorLabels" -}}
app.kubernetes.io/name: {{ .Release.Name }}-master-key-regenerator-app
app.kubernetes.io/instance: {{ .Release.Name }}-master-key-regenerator
{{- end }}
