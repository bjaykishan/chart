...
ssomigration.log_level="{{ .Values.ssomigration.log_level }}"
ssomigration.log_file_max_size="{{ .Values.ssomigration.log_file_max_size }}"
ssomigration.log_file_count="{{ .Values.ssomigration.log_file_count }}"
